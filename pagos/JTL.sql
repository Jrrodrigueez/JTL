...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-12-2019 a las 18:04:08
...
CREATE TABLE `estudiantes` ( 
 ...
 `dateadd` datetime NOT NULL,
	  ...
	  FOREIGN KEY (`curso_cursos`) REFERENCES curso(cursos) 
 ...
 ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_spanish_ci COMMENT = 'estudiantes';
...
CREATE TABLE `empleado` (
	...
	`PRnombreEMP` VARCHAR(25) NOT NULL , 
	`SGnombreEMP` VARCHAR(25) NOT NULL , 
	`PRapellidoEMP` VARCHAR(25) NOT NULL , 
	`SGapellidoEMP` VARCHAR(25) NOT NULL ,
...
ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_spanish_ci COMMENT = 'empleado';

--
-- Estructura de tabla `curso`
--

CREATE TABLE `curso` (
	`ID_curso` INT(11) NOT NULL AUTO_INCREMENT ,
	`cursos` SET  ('PRIMERO','SEGUNDO','TERCERO','CUARTO','QUINTO','SEXTO','SEPTIMO','OCTAVO','NOVENO','DECIMO','ONCE') NOT NULL ,
		PRIMARY KEY (`ID_curso`)) 
	
ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_spanish_ci COMMENT = 'curso';
...
CREATE TABLE `usuarios` (
	...
	`password` VARCHAR(50) NOT NULL ,
		...
		FOREIGN KEY (`identificacion_EMP`) REFERENCES empleado(`identificacion_EMP`) 
		ON UPDATE CASCADE ON DELETE RESTRICT ,
		FOREIGN KEY (`identificacion_EST`) REFERENCES estudiantes(`identificacion_EST`) 
		ON UPDATE CASCADE ON DELETE RESTRICT 
		)
ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_spanish_ci COMMENT = 'usuarios';
...
CREATE TABLE `pago` (
	...
	`ID_estudiantes` INT(11) NOT NULL AUTO_INCREMENT ,
	`ID_curso` INT(11) NOT NULL AUTO_INCREMENT ,
	`tipo_pago` SET('Efectivo','Consignacion') NOT NULL ,
	`subtipo_pago` SET('Total','Parcial') NOT NULL ,
	`fecha_pago` TIMESTAMP NOT NULL ,
	`VALOR` INT(10) NOT NULL ,
		PRIMARY KEY (`ID_pago`) ,
		FOREIGN KEY (`estudiantes_PRnombreEST` , `estudiantes_SGnombreEST` , `estudiantes_PRapellidoEST` , `estudiantes_SGapellidoEST` , `estudiantes_identificacion_EST` , `estudiantes_telefonoEST` , `estudiantes_celularEST` ) REFERENCES estudiantes(`PRnombreEST`, `SGnombreEST`, `PRapellidoEST` , `SGapellidoEST` , `identificacion_EST` , `telefonoEST` , `celularEST` ) 
		ON UPDATE CASCADE ON DELETE RESTRICT ,
		FOREIGN KEY (`curso_cursos`) REFERENCES curso(cursos)
		ON UPDATE CASCADE ON DELETE RESTRICT 
		)
ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_spanish_ci COMMENT = 'pago';
...
CREATE TABLE `rol` (
	...
	`Roles` SET (Administrativo, Funcionario, Estudiante),
		PRIMARY KEY (`ID_rol`)
		)
ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_spanish_ci COMMENT = 'rol';
...
CREATE TABLE `departamentos` (
  `id_depto` varchar(10) COLLATE utf8mb4_spanish_ci NOT NULL,
...
CREATE TABLE `municipios` (
  `id_municipio` varchar(10) COLLATE utf8mb4_spanish_ci NOT NULL,
...
INSERT INTO `municipios` (`id_municipio`, `nombre_municipio`, `id_depto`) VALUES
('001', 'MEDELLIN', '05'),
('002', 'ABEJORRAL', '05'),
('004', 'ABRIAQUI', '05'),
('021', 'ALEJANDRIA', '05'),
...
('631', 'SABANETA', '05'),
('642', 'SALGAR', '05'),
('647', 'SAN ANDRES DE CUERQU', '05'),
('649', 'SAN CARLOS', '05'),
('652', 'SAN FRANCISCO', '05'),
('656', 'SAN JERONIMO', '05'),
('658', 'SAN JOSE DE LA MONTA', '05'),
...
('077', 'BAJO BAUDO', '27'),
('099', 'BOJAYA', '27'),
('135', 'EL CANTON DEL SAN PA', '27'),
('150', 'CARMEN DEL DARIEN', '27'),
('160', 'CERTEGUI', '27'),
('205', 'CONDOTO', '27'),
('245', 'EL CARMEN DE ATRATO', '27'),
('250', 'EL LITORAL DEL SAN J', '27'),
('361', 'ISTMINA', '27'),
('372', 'JURADO', '27'),
('413', 'LLORO', '27'),
('425', 'MEDIO ATRATO', '27'),
...
('675', 'SALAMINA', '47'),
('692', 'SAN SEBASTIAN DE BUE', '47'),
('703', 'SAN ZENON', '47'),
('707', 'SANTA ANA', '47'),
('720', 'SANTA BARBARA DE PIN', '47'),
('745', 'SITIONUEVO', '47'),
('798', 'TENERIFE', '47'),
('960', 'ZAPAYAN', '47'),
...
('686', 'SAN MIGUEL', '68'),
('689', 'SAN VICENTE DE CHUCU', '68'),
('705', 'SANTA BARBARA', '68'),
('720', 'SANTA HELENA DEL OPO', '68'),
('745', 'SIMACOTA', '68'),
('755', 'SOCORRO', '68'),
('770', 'SUAITA', '68'),
('773', 'SUCRE', '68'),
...
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `municipios_ibfk_1` FOREIGN KEY (`id_depto`) REFERENCES `departamentos` (`id_depto`);
COMMIT;
